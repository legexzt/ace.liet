                ...
                <div className="footer__grid">
                    <div className="footer__brand">
                        <div className="footer__logo">
                            ...
                            <div>
                                <h3 className="footer__logo-title">ACE</h3>
                                <p className="footer__logo-sub">Sanketika 2026</p>
                            </div>
                        </div>
                        <p className="footer__desc">
                            Association of Computer Engineers — Department of Computer Science & Engineering,
                            Lords Institute of Engineering & Technology.
                        </p>
                        <div className="footer__socials">
                            <a href="https://www.instagram.com/ace_.liet" target="_blank" rel="noopener noreferrer" className="footer__social-link" title="Instagram">
                            ...
                            <a href="https://chat.whatsapp.com/EamAaMcvwR924jljxsn6Dz" target="_blank" rel="noopener noreferrer" className="footer__social-link" title="WhatsApp">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
