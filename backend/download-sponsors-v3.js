...
const images = [
    ...
    { name: 'lords-skill.png', url: 'https://www.lords.ac.in/wp-content/uploads/2021/11/Lords-Skill-Academy.png' }
];

const headers = {
    'User-Agent': 'ReactApp/1.0 (Contact: ace@lords.ac.in) Node.js-Fetch',
